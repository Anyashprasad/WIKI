                ...
                <motion.div className="max-w-4xl mx-auto" variants={containerVariants} initial="hidden" animate="visible">
                    ...
                    <motion.div variants={itemVariants} className="text-center mb-16">
                        <div className="relative w-48 h-48 mx-auto mb-8">
                            ...
                            <img src="/profile.jpg" alt="Anyash Prasad" className="w-full h-full rounded-full object-cover border-4 border-black relative z-10"/>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <Card className="bg-gray-900 border-gray-700">
                                ...
                                <CardContent className="flex flex-wrap gap-2">
                                    {["Python", "Java", "C", "SQL", "Linux", "VMware", "Fortinet", "GitHub", "Flask"].map(skill => (<Badge key={skill} variant="outline" className="border-green-400/30 text-green-400">
                                            {skill}
                                        </Badge>))}
                                </CardContent>
                            </Card>
                            <Card className="bg-gray-900 border-gray-700">
                                ...
                                <CardContent className="flex flex-wrap gap-2">
                                    {["Burp Suite", "OpenVAS", "Zenmap", "Wireshark", "Deep Learning", "CNN", "XceptionNet", "VAPT"].map(skill => (<Badge key={skill} variant="outline" className="border-blue-400/30 text-blue-400">
                                            {skill}
                                        </Badge>))}
                                </CardContent>
                            </Card>
