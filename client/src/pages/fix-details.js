        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              <img src="/logo.png" alt="WIKI Security Scanner" className="h-8 w-auto" onError={(e) => {
          ...
          <Card className="bg-gray-900 border-gray-700">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                {!generateFixMutation.data && (<Button onClick={() => generateFixMutation.mutate(vulnerability)} disabled={generateFixMutation.isPending} className="bg-green-400 text-black hover:bg-green-300">
                    {generateFixMutation.isPending ? "Generating..." : "Generate Fix"}
                  </Button>)}
              </div>
            </CardHeader>
            <CardContent>
              {generateFixMutation.isPending && (<div className="space-y-4">
              ...
              {generateFixMutation.data && (<div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 text-green-400">
                      <CheckCircle className="h-5 w-5"/>
                      <span>Fix Generated Successfully</span>
                    </div>
                    <Button variant="outline" size="sm" onClick={() => handleCopy(generateFixMutation.data.fix)} className="text-gray-400 border-gray-600 hover:bg-gray-800">
              ...
              {generateFixMutation.error && (<div className="text-center py-8">
